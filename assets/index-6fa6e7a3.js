...
function EventSchedule() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative", "aria-label": "Chronological wedding events", children: eventsData.slice(0, 6).map((event, index2) => {
...
function AmbientToggle() {
  const [isOn, setIsOn] = reactExports.useState(false);
  const ctxRef = reactExports.useRef(null);
  const gainRef = reactExports.useRef(null);
  const oscARef = reactExports.useRef(null);
  const oscBRef = reactExports.useRef(null);
