...
const heroLogo = "/assets/image0-e76347db.png";
const gridCellImage = "/assets/E594F4E0-F076-4E44-9713-F238456FCC3D-a45d07d9.png";
const alternateGridCellImage = "/assets/AD10A774-1DEF-4999-9AAB-E59CB69AC128-cc58dd70.png";
...
function seeded(index2) {
  const x2 = Math.sin((index2 + 1) * 97.13) * 1e4;
  return x2 - Math.floor(x2);
}
function AnimatedGrid({ className, fixedCells, columns, rows, containerStyle }) {
  const fixedCellSet = reactExports.useMemo(() => new Set(fixedCells), [fixedCells]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute z-0 pointer-events-none ${className}`, style: containerStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: cells.map((cell) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            animate: fixedCellSet.has(cell.id) ? void 0 : { backgroundColor: [cell.baseColor, cell.altColor, cell.baseColor] },
            transition: fixedCellSet.has(cell.id) ? void 0 : { duration: cell.duration, delay: cell.delay, repeat: Infinity, ease: "easeInOut" },
            style: fixedCellSet.has(cell.id) ? { backgroundColor: fixedGridColor } : { border: "1px solid #FCD556" },
            children: showGridCellImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
...
function Hero() {
  const [viewport, setViewport] = reactExports.useState({ width: 0, height: 0 });
  reactExports.useEffect(() => {
  ...
  const mobileRowSpan = reactExports.useMemo(() => Math.max(3, Math.round(mobileRows * 0.45)), [mobileRows]);
  const mobileRowStart = reactExports.useMemo(
    () => Math.max(1, Math.floor((mobileRows - mobileRowSpan) / 2) + 1),
    [mobileRows, mobileRowSpan]
  );
  const mobileFixedCells = reactExports.useMemo(
    () => buildFixedCells({
      columns: 5,
      colStart: 2,
      colSpan: 3,
  ...
  const mobileGridStyle = reactExports.useMemo(
  ...
  const ambientOrbs = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.section,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 z-[1]", children: ambientOrbs.map((orb) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedGrid, { className: "hidden md:block inset-0", fixedCells: desktopFixedCells, columns: 8, rows: 5 })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full flex-col items-center justify-start overflow-visible pt-4 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full flex-1 min-h-0 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.img,
                    {
                      src: heroLogo,
                      alt: "Wedding logo",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.h1,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-center", children: "Chavva's" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-center whitespace-nowrap", children: "Wedding Invitation" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.p,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-center", children: "Join us for a celebration" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-center", children: "of" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-center", children: "love, tradition, and joy" })
                      ]
                    }
                  )
                ] })
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full w-full flex-col items-center justify-start overflow-visible pt-4 text-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.h1,
                    {
                      ...
                      children: "Chavva's Wedding Invitation"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.p,
                    {
                      ...
                      children: "Join us for a celebration of love, tradition, and joy"
                    }
                  )
                ] })
              }
...
const eventsData = [
  {
    id: 5,
    title: "Srirastu! Subhamastu! Kalyanamastu!",
    subtitle: "With the divine blessing of",
    subtitle2: "Late Sri. Chavva Suryanarayana Reddy & Smt. Chavva Venkatalakshmi",
    subtitle3: "and",
    subtitle4: "Late Sri. R. Eshwar Reddy & Late Smt. R. Rajamani.",
    subtitle5: "We,",
    subtitle6: "Sri. Chavva Prasad Reddy & Smt. Chavva Swarnalatha,",
    subtitle7: "cordially invite you to join us in celebrating the wedding festivities of our beloved daughter",
    title2: "Chavva Ashritha Reddy",
    subtitle8: "with",
    title3: "Kalla Nipun Reddy",
    subtitle9: "beloved son of",
    subtitle10: "Sri. Kalla Raghunatha Reddy & Smt. Tarimela Sailaja"
  },
  {
    id: 0,
    title: "Haldi Ceremony",
    subtitle: "A splash of Turmeric, a dash of happiness",
    date: "24th August 2026",
    time: "9:00 AM - 11:00 AM",
    phase: "Day 1",
    venue: "Vizag Film Nagar Cultural Centre",
    address: "Kapuluppada, Visakhapatnam",
    mapUrl: "https://maps.app.goo.gl/RrFs8x5reprTKkaZA?g_st=ic",
    dressCode: "Indo-Western | Pink hues",
    color: "pop-pink",
    theme: {
      bg: "from-[#fffde7] via-[#fff9c4] to-[#fff59d]",
      panel: "#fff8e1",
      accent: "#f9a825",
      ink: "#5d4037"
    },
    motif: "sunburst",
    story: "Turmeric paste and blessings mark the beginning of the wedding journey.",
    storyFrames: [
      "Haldi applied with joy",
      "Family gathers close",
      "Blessings flow freely"
    ],
    designNote: "Golden yellows, marigold petals, and turmeric-stained joy.",
    highlights: [
      "Haldi ritual",
      "Family blessings",
      "Photo moments"
  ...
  },
  {
    ...
    subtitle: "Henna, Laughter, & Courtyard Songs",
    date: "24th August 2026",
    ...
    address: "Kapuluppada, Visakhapatnam",
    mapUrl: "https://maps.app.goo.gl/RrFs8x5reprTKkaZA?g_st=ic",
    dressCode: "Casual attire in shades of Blue",
    color: "pop-blue",
    theme: {
      bg: "from-[#fff6f0] via-[#ffe7df] to-[#ffd5cb]",
      panel: "#fff4da",
      accent: "#ff6b35",
      ink: "#6f1d1b"
    },
    motif: "paisley",
    story: "As the sun sets, hands bloom with intricate mehendi while cousins trade old stories and aunties hum folk tunes. This evening opens our wedding week with color, scent, and playful chaos.",
    storyFrames: [
      "Henna patterns bloom",
      "Courtyard songs rise",
      "Laughter spills everywhere"
    ],
    designNote: "Terracotta drapes, marigold strings, brass diyas, and hand-painted signage inspired by old bazaar posters.",
    highlights: [
      "Live mehendi corners",
      "Dhol welcome jam",
      "Street-style chaat bar"
    ]
  },
  {
    id: 2,
    title: "Pellikuturu",
    subtitle: "It's time to get our Ammayi ready for the big day!",
    date: "25th August 2026",
    time: "10:30 AM onwards",
    phase: "Day 2",
    venue: "Namasvi Conventions",
    address: "Sheelanagar, Visakhapatnam",
    mapUrl: "https://maps.app.goo.gl/phE197ec2r22QozZ8?g_st=ic",
    dressCode: "Telugu Traditional attire",
    color: "pop-saffron",
    theme: {
      bg: "from-[#f2f8ff] via-[#e3f0ff] to-[#d2e7ff]",
      panel: "#fff5c9",
      accent: "#f59e0b",
      ink: "#7c2d12"
    },
    motif: "sunburst",
    story: "We start with haldi blessings in a swirl of yellow petals, then turn the volume up for sangeet night. Expect loud beats, inside jokes, and one dramatic family dance battle.",
    storyFrames: [
      "Haldi in golden light",
      "Drums shake the floor",
      "Families dance in sync"
    ],
    designNote: "Mirror-work textiles, retro disco bulbs, hand-block prints, and bright saffron stage backdrops.",
    highlights: [
      "Haldi ritual circle",
      "Family choreography sets",
      "Late-evening dessert parade"
    ]
  },
  {
    id: 3,
    title: "Vakkaku Sastram",
    subtitle: "As two families unite to exhange traditions and blessings",
    date: "25th August 2026",
    ...
    address: "Sheelanagar, Visakhapatnam",
    mapUrl: "https://maps.app.goo.gl/phE197ec2r22QozZ8?g_st=ic",
    dressCode: "Indian attire in rich jewel tones",
    color: "pop-deep-red",
    theme: {
      bg: "from-[#f7f0ff] via-[#ece1ff] to-[#e3d2ff]",
      panel: "#ffe2d8",
      accent: "#8b0000",
      ink: "#3b0d11"
    },
    motif: "lotus",
    story: "Sacred pre-wedding rituals that mark the auspicious beginning of the wedding journey.",
    storyFrames: [
      "Rituals begin",
      "Blessings given",
      "Sacred start"
    ],
    designNote: "Traditional Telugu ceremonial aesthetics.",
    highlights: [
      "Vakkaku ritual",
      "Family blessings",
      "Sacred ceremonies"
  ...
  },
  {
    id: 4,
    title: "Kalyanam",
    subtitle: "Sacred vows, seven steps & one lifetime",
    date: "26th August 2026",
    time: "07:00 PM onwards",
    phase: "Day 3",
    venue: "Radisson Blu Resort",
    address: "Rushikonda, Visakhapatnam",
    mapUrl: "https://maps.app.goo.gl/5SHU6JFoAW3Mgxrb6?g_st=ic",
    dressCode: "11:44 PM",
    color: "pop-deep-red",
    theme: {
      bg: "from-[#f7f0ff] via-[#ece1ff] to-[#e3d2ff]",
    ...
    motif: "lotus",
    story: "At the mandap, with prayers and conch shells in the air, we promise a lifetime to each other.",
    storyFrames: [
      "Varmala exchange",
      "Seven sacred pheras",
      "Blessings crown the morning"
    ],
    designNote: "Banarasi textures, temple bells, and deep vermilion floral compositions.",
    highlights: [
      "Varmala exchange",
      "Seven sacred pheras",
      "Family blessings"
  ...
  },
  {
    id: 6,
    title: "Reception",
    subtitle: "Celebrating the beginning of forever!",
    date: "29th August 2026",
    time: "07:00 PM onwards",
    phase: "Day 3",
    venue: "R Convention",
    address: "Beside Sakshi office , Bengalore highway, Anantapur",
    mapUrl: "https://maps.app.goo.gl/MUQmQ5uHdYkMPbqcA?g_st=ic",
    dressCode: "",
    color: "pop-gold",
    theme: {
      bg: "from-[#fff8e1] via-[#fce4b3] to-[#f1c96a]",
      panel: "#fff3d0",
      accent: "#b8860b",
      ink: "#4b2e0f"
    },
    motif: "sunburst",
    story: "The celebration continues into the evening with a festive reception, glowing lights, and cherished moments with loved ones.",
    storyFrames: [
      "Grand welcome",
      "Dinner and music",
      "Memories glow on"
    ],
    designNote: "Golden lights, warm florals, and a glamorous evening ambiance.",
    highlights: [
      "Grand welcome",
      "Live music",
      "Dinner celebration"
...
const page2Bg = "/assets/Page2_BG-c58bb232.png";
const page2BgMain = "/assets/page2_bgmain-26bada0c.png";
const flowerTopLeft = "/assets/Flower_pt-0f7e4ead.png";
const flowerBottomRight = "/assets/Flower_bt-25257a4c.png";
const smallLamp = "/assets/smalllamp-a7b58907.png";
const shadesOfBlue = "/assets/shadesofblue-0b2a043d.png";
const shadesOfPink = "/assets/shadesofpink-cf5f5530.png";
const tallLamp = "/assets/talllamp-9b6074dd.png";
const pkMain = "/assets/pk_main-26e58db2.png";
const pkBg = "/assets/pk_bg-4f7e4292.png";
const ltFlower = "/assets/lt_flower-85126b3e.png";
const rtFlower = "/assets/rt_flower-859a5dd8.png";
const rcBg = "/assets/rc_bg-a0f2ae7a.png";
const rcInner = "/assets/rc_inner-120eb498.png";
const rcItop = "/assets/rc_itop-6ccb2779.png";
const petal1 = "/assets/petal1-821336d1.png";
const petal2 = "/assets/petal2-4029af00.png";
const petal3 = "/assets/petal3-a93ec644.png";
const haldiBg = "/assets/haldi_bg-9562b421.png";
const haldiInner = "/assets/haldi_inner-c78c2d64.png";
const haldiBorder = "/assets/haldi_border-5e45f042.png";
const vkBg = "/assets/vk_bg-772112f7.png";
const vkInner = "/assets/vk_inner-35451036.png";
const vkTop = "/assets/vk_top-d1f7eb36.png";
const vkProp = "/assets/vk_prop-d21a2121.png";
const bt1 = "/assets/bt1-a8db6a35.png";
const bt2 = "/assets/bt2-4639d63e.png";
const pgBorder = "/assets/pg_border-82f32b2b.png";
const pgBg = "/assets/pg_bg-9bdc8cb2.png";
const pgCenter = "/assets/pg_center-56db11f9.png";
const wedBg = "/assets/wed_bg-104d1e3e.png";
const wedInner = "/assets/wed_inner-e86ad977.png";
const wedFl1 = "/assets/wed_fl1-d301e7a5.png";
const wedFl2 = "/assets/wed_fl2-8f5a21c2.png";
const wedLt = "/assets/wed_lt-b4029fd1.png";
const wedLa1 = "/assets/wed_la1-b74537d2.png";
const wedLa2 = "/assets/wed_la2-53e9bec0.png";
const wedLa3 = "/assets/wed_la3-5d8a2ae4.png";
const bell1 = "/assets/bell1-b8a64859.png";
const bell2 = "/assets/bell2-9ae9ebf9.png";
const bell3 = "/assets/bell3-ee118b41.png";
const PETAL_SRCS = [petal1, petal2, petal3];
const PETAL_CONFIGS = [
  { src: 0, left: "8%", size: "6%", duration: 6.2, delay: 0, sway: [0, 12, -8, 15, 0], spin: [0, 40, -20, 60, 0] },
  ...
  { src: 2, left: "13%", size: "7%", duration: 6, delay: 3.2, sway: [0, 6, -14, 10, 0], spin: [0, -60, 20, -50, 0] },
  { src: 0, left: "35%", size: "5.5%", duration: 7.2, delay: 1.8, sway: [0, -10, 8, -12, 0], spin: [0, 30, -55, 40, 0] },
  { src: 1, left: "57%", size: "6%", duration: 5.9, delay: 2, sway: [0, 12, -8, 16, 0], spin: [0, -40, 60, -25, 0] },
  { src: 2, left: "79%", size: "7%", duration: 6.7, delay: 0.4, sway: [0, -16, 10, -8, 0], spin: [0, 45, -30, 55, 0] },
  { src: 0, left: "47%", size: "5%", duration: 8, delay: 3.5, sway: [0, 8, -12, 6, 0], spin: [0, -35, 25, -45, 0] },
...
const sectionLayouts = [
  {
    ...
    cardBg: "transparent",
    Decor: () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-[0.08]", style: { backgroundImage: "repeating-linear-gradient(45deg,#fff 0,#fff 1px,transparent 0,transparent 50%)", backgroundSize: "22px 22px" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          className: "absolute -top-24 -left-24 w-80 h-80 rounded-full border-4 border-white/10",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          className: "absolute -bottom-20 -right-20 w-64 h-64 rounded-full border-2 border-white/8",
  ...
  },
  {
    ...
    cardBg: "transparent",
    Decor: () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-4 top-1/2 -translate-y-1/2 font-display text-[14rem] leading-none text-white/[0.05] select-none pointer-events-none", children: "✦" }),
  ...
  },
  {
    ...
    cardBg: "transparent",
    Decor: () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      [300, 220, 150, 80].map((size, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-[0.05]", style: { backgroundImage: "radial-gradient(circle, #fff 1px, transparent 1px)", backgroundSize: "18px 18px" } })
    ] })
  },
  {
    ...
    cardBg: "transparent",
    Decor: () => /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      [0, 1, 2, 3, 4, 5, 6].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          className: "absolute right-8 top-10 text-white/18 text-8xl select-none",
          animate: { rotate: [0, 360] },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          className: "absolute left-6 bottom-12 text-white/14 text-5xl select-none",
          animate: { rotate: [360, 0] },
...
function Reveal({ children, type = "fadeUp", delay: delay2 = 0, amount = 0.2 }) {
  const variants = {
    fadeUp: {
      initial: { opacity: 0, y: 24 },
      whileInView: { opacity: 1, y: 0 },
      transition: { duration: 0.55, delay: delay2, ease: [0.22, 1, 0.36, 1] }
    },
    slideLeft: {
    ...
    zoomIn: {
      ...
      transition: { duration: 0.5, delay: delay2, ease: [0.22, 1, 0.36, 1] }
    },
    rotateIn: {
  ...
  const v2 = variants[type] || variants.fadeUp;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      initial: v2.initial,
      whileInView: v2.whileInView,
...
function PopArtImage({ accent, ink, label, variant }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pastel-lace opacity-45 rounded-2xl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 300 180", className: "w-full h-36", "aria-hidden": "true", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "0", y: "0", width: "300", height: "180", fill: accent, opacity: "0.2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: variant === 1 ? "78" : "224", cy: "90", r: "56", fill: accent, opacity: "0.55" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M40 132 L150 38 L260 132", fill: "none", stroke: ink, strokeWidth: "10", strokeLinecap: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M30 148 L270 148", fill: "none", stroke: ink, strokeWidth: "7", strokeLinecap: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "150", cy: "90", r: "20", fill: ink, opacity: "0.8" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-xs font-semibold tracking-widest uppercase text-[#7d6b74] bg-white/55 backdrop-blur-sm", children: label })
      ]
    }
  );
}
function MotifSticker({ motif, accent }) {
  ...
  if (motif === "paisley") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: shared, viewBox: "0 0 100 100", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M74 13c-23 0-42 18-42 42 0 20 14 34 33 34 14 0 25-11 25-25 0-11-8-20-19-20-9 0-16 8-16 17 0 7 6 13 13 13 5 0 9-4 9-9", stroke: accent, strokeWidth: "7", strokeLinecap: "round" }) });
  }
  if (motif === "sunburst") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: shared, viewBox: "0 0 100 100", fill: "none", "aria-hidden": "true", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: "50", r: "16", fill: accent }),
      [...Array(12)].map((_, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1, y1, x2, y2, stroke: accent, strokeWidth: "5", strokeLinecap: "round" }, i);
      })
    ] });
  }
  if (motif === "lotus") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: shared, viewBox: "0 0 100 100", fill: "none", "aria-hidden": "true", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M50 20c6 10 6 22 0 32-6-10-6-22 0-32Z", fill: accent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M28 34c11 4 19 14 22 25-11-4-19-14-22-25Z", fill: accent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M72 34c-11 4-19 14-22 25 11-4 19-14 22-25Z", fill: accent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M17 55c13-1 25 4 33 13-13 1-25-4-33-13Z", fill: accent }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M83 55c-13-1-25 4-33 13 13 1 25-4 33-13Z", fill: accent })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: shared, viewBox: "0 0 100 100", fill: "none", "aria-hidden": "true", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M20 70c0-26 19-46 43-46h17v15H64c-14 0-25 13-25 31v10H20V70Z", fill: accent }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M80 31c0 26-19 46-43 46H20V62h17c14 0 25-13 25-31V21h18v10Z", fill: accent, opacity: "0.7" })
  ] });
}
function EventSchedule() {
  const zeroSectionRef = reactExports.useRef(null);
  const { scrollYProgress: scrollYProgress0 } = useScroll({ target: zeroSectionRef, offset: ["start end", "end start"] });
  const smooth0 = useSpring(scrollYProgress0, { stiffness: 60, damping: 20, restDelta: 1e-3 });
  ...
  const firstSectionRef = reactExports.useRef(null);
  const { scrollYProgress } = useScroll({
    target: firstSectionRef,
    offset: ["start end", "end start"]
  });
  const smooth = useSpring(scrollYProgress, { stiffness: 60, damping: 20, restDelta: 1e-3 });
  const darkOverlayOpacity = useTransform(smooth, [0, 0.1, 0.3], [1, 0.9, 0]);
  const lampGlowOpacity = useTransform(
    smooth,
    [0, 0.06, 0.07, 0.08, 0.09, 0.1, 0.11, 0.12, 0.13, 0.14, 0.15, 0.16, 0.17, 0.25],
    [0, 0, 0.75, 0.05, 0.9, 0.08, 1, 0.12, 0.85, 0.22, 0.95, 0.3, 0.92, 1]
  );
  ...
  const qrOpacity = useTransform(smooth, [0.2, 0.3], [0, 1]);
  const qrScale = useTransform(smooth, [0.2, 0.3], [0.88, 1]);
  const secondSectionRef = reactExports.useRef(null);
  const { scrollYProgress: scrollYProgress2 } = useScroll({ target: secondSectionRef, offset: ["start end", "end start"] });
  const smooth2 = useSpring(scrollYProgress2, { stiffness: 60, damping: 20, restDelta: 1e-3 });
  ...
  const qrOpacity2 = useTransform(smooth2, [0.2, 0.3], [0, 1]);
  const qrScale2 = useTransform(smooth2, [0.2, 0.3], [0.88, 1]);
  const thirdSectionRef = reactExports.useRef(null);
  const { scrollYProgress: scrollYProgress3 } = useScroll({ target: thirdSectionRef, offset: ["start end", "end start"] });
  const smooth3 = useSpring(scrollYProgress3, { stiffness: 60, damping: 20, restDelta: 1e-3 });
  ...
  const qrOpacity3 = useTransform(smooth3, [0.2, 0.3], [0, 1]);
  const qrScale3 = useTransform(smooth3, [0.2, 0.3], [0.88, 1]);
  const firstSectionTextShadow = "0 5px 10px rgba(49, 58, 2, 0.5)";
  const firstSectionOverlayWidth = "min(94vw, 42rem)";
  const firstSectionOverlayScale = 1;
  ...
  const HALDI_PARTICLES = [
    { left: "5%", size: 7, color: "#FFD700", delay: 0, duration: 3.4, sway: [0, -8, 4], spin: [0, 120, 240] },
    ...
    { left: "65%", size: 5, color: "#FF8C00", delay: 1.1, duration: 3, sway: [0, 8, -4], spin: [0, -110, -220] },
    ...
    { left: "9%", size: 5, color: "#FF8C00", delay: 1.8, duration: 3, sway: [0, 7, -4], spin: [0, -160, -320] },
    { left: "17%", size: 7, color: "#FFD700", delay: 0.5, duration: 3.7, sway: [0, -9, 6], spin: [0, 80, 160] },
    { left: "26%", size: 4, color: "#FFA500", delay: 1, duration: 2.6, sway: [0, 5, -7], spin: [0, -50, -100] },
  ...
  const qrOpacity4 = useTransform(smooth4, [0.2, 0.3], [0, 1]);
  const qrScale4 = useTransform(smooth4, [0.2, 0.3], [0.88, 1]);
  const fifthSectionRef = reactExports.useRef(null);
  const { scrollYProgress: scrollYProgress5 } = useScroll({ target: fifthSectionRef, offset: ["start end", "end start"] });
  const smooth5 = useSpring(scrollYProgress5, { stiffness: 60, damping: 20, restDelta: 1e-3 });
  ...
  const qrOpacity5 = useTransform(smooth5, [0.2, 0.3], [0, 1]);
  const qrScale5 = useTransform(smooth5, [0.2, 0.3], [0.88, 1]);
  const sixthSectionRef = reactExports.useRef(null);
  const { scrollYProgress: scrollYProgress6 } = useScroll({ target: sixthSectionRef, offset: ["start end", "end start"] });
  const smooth6 = useSpring(scrollYProgress6, { stiffness: 60, damping: 20, restDelta: 1e-3 });
  ...
  const qrOpacity6 = useTransform(smooth6, [0.2, 0.3], [0, 1]);
  const qrScale6 = useTransform(smooth6, [0.2, 0.3], [0.88, 1]);
  ...
  const sixthSectionInnerSize = { width: "100%", height: "100%", scaleX: 1.1, scaleY: 1 };
  ...
  const WEDDING_SPARKLES = [
    { left: "7%", top: "8%", size: 13, delay: 0, duration: 1.8 },
    ...
    { left: "67%", top: "19%", size: 10, delay: 1.5, duration: 2 },
    ...
    { left: "46%", top: "90%", size: 8, delay: 1.3, duration: 2 },
    ...
    { left: "77%", top: "48%", size: 10, delay: 1.9, duration: 2 },
  ...
  const fifthSectionInnerSize = { width: "95%", height: "98%", scaleX: 0.9, scaleY: 1 };
  ...
  const MARIGOLD_PILE = [
    { img: bt1, left: "4%", size: "5%", delay: 0, duration: 2.8, sway: [0, -8, 4], spin: [0, -40, -80] },
    { img: bt2, left: "12%", size: "4%", delay: 0.6, duration: 2.4, sway: [0, 6, -4], spin: [0, 30, 70] },
    { img: bt1, left: "21%", size: "6%", delay: 1.2, duration: 3, sway: [0, -6, 8], spin: [0, -20, -55] },
    ...
    { img: bt2, left: "69%", size: "5%", delay: 1, duration: 2.7, sway: [0, 9, -5], spin: [0, 40, 80] },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative", "aria-label": "Chronological wedding events", children: eventsData.slice(0, 7).map((event, index2) => {
    ...
    const isZeroSection = index2 === 0;
    const isThirdSection = index2 === 1;
    const isFirstSection = index2 === 2;
    const layout2 = sectionLayouts[index2 % sectionLayouts.length];
    const isSecondSection = index2 === 3;
    const isFourthSection = index2 === 4;
    const isFifthSection = index2 === 5;
    const isSixthSection = index2 === 6;
    const sectionStyle = isZeroSection ? { backgroundImage: `url(${pgBg})`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" } : isThirdSection ? { backgroundColor: "#D4A017" } : isFirstSection ? { backgroundImage: `url(${page2Bg})`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundColor: "#0F6606" } : isSecondSection ? { backgroundImage: `url(${pkMain})`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundColor: secondSectionImages.bgColor } : isFourthSection ? { backgroundColor: "#1a1a2e" } : isFifthSection ? { backgroundColor: "#1a0a0a" } : isSixthSection ? { backgroundColor: "#2f1b10" } : {};
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        id: `event-${event.id}`,
        ...
        style: sectionStyle,
        children: isZeroSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[1] mx-auto flex w-full justify-center", style: { minHeight: "max-content" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", style: { width: firstSectionOverlayWidth, aspectRatio: "852 / 1261" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center px-[8%]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: pgCenter, alt: "", "aria-hidden": "true", className: "mx-auto mb-[3%] object-contain", style: { width: "40%", opacity: titleOpacity0, scale: titleScale0 } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.h2, { className: "font-script-title font-bold text-gray-800 mb-[3%]", style: { fontSize: "clamp(0.9rem, 3cqw, 1.4rem)", opacity: titleOpacity0, scale: titleScale0 }, children: event.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { style: { opacity: contentOpacity0, y: contentY0 }, children: [
                  [event.subtitle, event.subtitle2, event.subtitle3, event.subtitle4, event.subtitle5].filter(Boolean).map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 italic mb-[1.5%]", style: { fontSize: "clamp(0.65rem, 2cqw, 0.88rem)" }, children: s }, i)),
                  event.subtitle6 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 italic font-bold mb-[1.5%]", style: { fontSize: "clamp(0.65rem, 2cqw, 0.88rem)" }, children: event.subtitle6 }),
                  event.subtitle7 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 italic mb-[1.5%]", style: { fontSize: "clamp(0.65rem, 2cqw, 0.88rem)" }, children: event.subtitle7 }),
                  event.title2 && /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-script-title font-bold text-gray-800 mt-[4%] mb-[2%]", style: { fontSize: "clamp(1.05rem, 3.8cqw, 1.7rem)" }, children: event.title2 }),
                  event.subtitle8 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 italic mb-[1.5%]", style: { fontSize: "clamp(0.65rem, 2cqw, 0.88rem)" }, children: event.subtitle8 }),
                  event.title3 && /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-script-title font-bold text-gray-800 mt-[4%] mb-[2%]", style: { fontSize: "clamp(1.05rem, 3.8cqw, 1.7rem)" }, children: event.title3 }),
                  event.subtitle9 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 italic mb-[1.5%]", style: { fontSize: "clamp(0.65rem, 2cqw, 0.88rem)" }, children: event.subtitle9 }),
                  event.subtitle10 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 italic font-bold mb-[1.5%]", style: { fontSize: "clamp(0.65rem, 2cqw, 0.88rem)" }, children: event.subtitle10 })
                ] })
              ]
            }
          ) }) }) }),
        ...
        ] }) : isThirdSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[1] mx-auto flex w-full justify-center", style: { minHeight: "max-content" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "relative",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none z-[8]", children: HALDI_PARTICLES.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    className: "absolute rounded-full",
                    style: { left: p2.left, top: "-3%", width: p2.size, height: p2.size, backgroundColor: p2.color },
                    animate: { y: [0, 1100], x: p2.sway, rotate: p2.spin, opacity: [0, 0.85, 0.85, 0] },
                    transition: { duration: p2.duration, repeat: Infinity, delay: p2.delay, ease: "linear" }
                  },
                  i
                )) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none z-[9]", children: HALDI_SPARKLES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "h-full w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                        ...
                        motion.div,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", style: { color: thirdSectionContent.venue.labelColor, textShadow: firstSectionTextShadow }, children: [
                                  "Venue: ",
                                  event.venue
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-snug", children: event.address })
                              ]
                            }
                          )
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[2%]", style: { marginTop: thirdSectionContent.cards.marginTop }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              motion.div,
                              {
                                className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`,
                                style: { backgroundColor: layout2.cardBg, width: thirdSectionContent.cards.width, marginInline: "auto" },
                                whileHover: { scale: 1.01 },
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${thirdSectionContent.cardTitle.fontClassName} font-semibold`, style: { marginLeft: thirdSectionContent.cardTitle.left, width: thirdSectionContent.cardTitle.width, textAlign: thirdSectionContent.cardTitle.textAlign, fontSize: thirdSectionContent.cardTitle.fontSize, color: thirdSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Date & Time" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: thirdSectionContent.cardBody.fontClassName, style: { marginLeft: thirdSectionContent.cardBody.left, width: thirdSectionContent.cardBody.width, textAlign: thirdSectionContent.cardBody.textAlign, fontSize: thirdSectionContent.cardBody.fontSize, color: thirdSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.date }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: thirdSectionContent.cardBody.fontClassName, style: { marginLeft: thirdSectionContent.cardBody.left, width: thirdSectionContent.cardBody.width, textAlign: thirdSectionContent.cardBody.textAlign, fontSize: thirdSectionContent.cardBody.fontSize, color: thirdSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.time })
                                ]
                              }
                            )
                          }
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              ...
                              {
                                className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`,
                                style: { backgroundColor: layout2.cardBg, marginTop: thirdSectionContent.cards.gap, width: thirdSectionContent.cards.width, marginInline: "auto" },
                                whileHover: { scale: 1.01 },
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${thirdSectionContent.cardTitle.fontClassName} font-semibold`, style: { marginLeft: thirdSectionContent.cardTitle.left, width: thirdSectionContent.cardTitle.width, textAlign: thirdSectionContent.cardTitle.textAlign, fontSize: thirdSectionContent.cardTitle.fontSize, color: thirdSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Dress Code" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: thirdSectionContent.cardBody.fontClassName, style: { marginLeft: thirdSectionContent.cardBody.left, width: thirdSectionContent.cardBody.width, textAlign: thirdSectionContent.cardBody.textAlign, fontSize: thirdSectionContent.cardBody.fontSize, color: thirdSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.dressCode }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto rounded-xl overflow-hidden", style: { width: thirdSectionContent.dressCodeImage.width, marginTop: thirdSectionContent.dressCodeImage.marginTop, padding: "4%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "img",
                                    {
                                      src: shadesOfPink,
                          ...
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              motion.div,
                              {
                                ...
                                whileHover: { scale: 1.01 },
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${thirdSectionContent.cardTitle.fontClassName} font-semibold`, style: { marginLeft: thirdSectionContent.cardTitle.left, width: thirdSectionContent.cardTitle.width, textAlign: thirdSectionContent.cardTitle.textAlign, fontSize: thirdSectionContent.cardTitle.fontSize, color: thirdSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Venue QR" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                    "a",
                                    {
                                      href: mapLink,
                                      ...
                                      children: [
                                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", style: { maxWidth: thirdSectionContent.qr.maxWidth }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: qrUrl, alt: `QR code for ${event.venue}`, className: "w-full bg-white p-[2%] shadow-md", loading: "lazy" }) }),
                                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          "div",
                                          {
                                            ...
                                            children: "Tap/Scan QR to Open Venue Map"
                                          }
                                        )
                                      ]
                                    }
        ...
        ] }) : isFirstSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              className: "absolute inset-0 z-50 pointer-events-none bg-black",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "h-full w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", children: [
                        ...
                        motion.div,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", style: { color: firstSectionContent.venue.labelColor, textShadow: firstSectionTextShadow }, children: [
                                  "Venue: ",
                                  event.venue
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-snug", children: event.address })
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[2%]", style: { marginTop: firstSectionContent.cards.marginTop }, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              ...
                              {
                                className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`,
                                style: { backgroundColor: layout2.cardBg, width: firstSectionContent.cards.width, marginInline: "auto" },
                                whileHover: { scale: 1.01 },
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${firstSectionContent.cardTitle.fontClassName} font-semibold`, style: { marginLeft: firstSectionContent.cardTitle.left, width: firstSectionContent.cardTitle.width, textAlign: firstSectionContent.cardTitle.textAlign, fontSize: firstSectionContent.cardTitle.fontSize, color: firstSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Date & Time" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: firstSectionContent.cardBody.fontClassName, style: { marginLeft: firstSectionContent.cardBody.left, width: firstSectionContent.cardBody.width, textAlign: firstSectionContent.cardBody.textAlign, fontSize: firstSectionContent.cardBody.fontSize, color: firstSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.date }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: firstSectionContent.cardBody.fontClassName, style: { marginLeft: firstSectionContent.cardBody.left, width: firstSectionContent.cardBody.width, textAlign: firstSectionContent.cardBody.textAlign, fontSize: firstSectionContent.cardBody.fontSize, color: firstSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.time })
                                ]
                              }
                            )
                          }
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              ...
                              {
                                className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`,
                                style: { backgroundColor: layout2.cardBg, marginTop: firstSectionContent.cards.gap, width: firstSectionContent.cards.width, marginInline: "auto" },
                                whileHover: { scale: 1.01 },
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${firstSectionContent.cardTitle.fontClassName} font-semibold`, style: { marginLeft: firstSectionContent.cardTitle.left, width: firstSectionContent.cardTitle.width, textAlign: firstSectionContent.cardTitle.textAlign, fontSize: firstSectionContent.cardTitle.fontSize, color: firstSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Dress Code" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: firstSectionContent.cardBody.fontClassName, style: { marginLeft: firstSectionContent.cardBody.left, width: firstSectionContent.cardBody.width, textAlign: firstSectionContent.cardBody.textAlign, fontSize: firstSectionContent.cardBody.fontSize, color: firstSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.dressCode }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                                    "img",
                                    {
                                      src: shadesOfBlue,
                          ...
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              motion.div,
                              {
                                ...
                                whileHover: { scale: 1.01 },
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${firstSectionContent.cardTitle.fontClassName} font-semibold`, style: { marginLeft: firstSectionContent.cardTitle.left, width: firstSectionContent.cardTitle.width, textAlign: firstSectionContent.cardTitle.textAlign, fontSize: firstSectionContent.cardTitle.fontSize, color: firstSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Venue QR" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                    "a",
                                    {
                                      href: mapLink,
                                      ...
                                      "aria-label": `Open maps for ${event.title}`,
                                      children: [
                                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", style: { maxWidth: firstSectionContent.qr.maxWidth }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: qrUrl, alt: `QR code for ${event.venue}`, className: "w-full bg-white p-[2%] shadow-md", loading: "lazy" }) }),
                                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                                          "div",
                                          {
        ...
        ] }) : isSecondSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { className: "absolute inset-0 z-50 pointer-events-none bg-black", style: { opacity: darkOverlayOpacity2 } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[1] mx-auto flex w-full justify-center", style: { minHeight: "max-content" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: firstSectionOverlayWidth, aspectRatio: "852 / 1261" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: secondSectionImages.bgMain, alt: "", "aria-hidden": "true", className: "absolute inset-0 h-full w-full object-contain object-center pointer-events-none", style: { transform: `scale(${secondSectionLayout.bgMain.scale})`, transformOrigin: "center center" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: secondSectionImages.flowerTopLeft, alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: secondSectionLayout.flowerLeft.left, bottom: secondSectionLayout.flowerLeft.bottom, width: secondSectionLayout.flowerLeft.width } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: secondSectionImages.flowerBottomRight, alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { right: secondSectionLayout.flowerRight.right, bottom: secondSectionLayout.flowerRight.bottom, width: secondSectionLayout.flowerRight.width } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden z-[24] pointer-events-none", children: PETAL_CONFIGS.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.img,
              {
                src: PETAL_SRCS[p2.src],
                alt: "",
                "aria-hidden": "true",
                className: "pointer-events-none absolute",
                style: { left: p2.left, top: "-5%", width: p2.size },
                animate: { y: [0, 1400], x: p2.sway, rotate: p2.spin, opacity: [0, 0.9, 0.9, 0] },
                transition: { duration: p2.duration, repeat: Infinity, delay: p2.delay, ease: "linear" }
              },
              i
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-20 overflow-hidden", style: { containerType: "inline-size", left: secondSectionContent.wrapper.left, top: secondSectionContent.wrapper.top, right: secondSectionContent.wrapper.right, bottom: secondSectionContent.wrapper.bottom }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "h-full w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-30 px-[4%]", style: { top: secondSectionContent.title.top, left: secondSectionContent.title.left, width: secondSectionContent.title.width, textAlign: secondSectionContent.title.textAlign }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.h3, { className: `${secondSectionContent.title.fontClassName} leading-[1.05]`, style: { fontSize: secondSectionContent.title.fontSize, color: secondSectionContent.title.color, textShadow: firstSectionTextShadow, opacity: titleOpacity2, scale: titleScale2 }, children: event.title }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: subtitleOpacity2, y: subtitleY2, filter: subtitleFilter2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${secondSectionContent.subtitle.fontClassName} font-bold`, style: { marginTop: secondSectionContent.subtitle.marginTop, marginLeft: secondSectionContent.subtitle.left, width: secondSectionContent.subtitle.width, textAlign: secondSectionContent.subtitle.textAlign, fontSize: secondSectionContent.subtitle.fontSize, color: secondSectionContent.subtitle.color, textShadow: firstSectionTextShadow }, children: event.subtitle }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: venueOpacity2, x: venueX2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: secondSectionContent.venue.fontClassName, style: { marginTop: secondSectionContent.venue.marginTop, marginLeft: secondSectionContent.venue.left, width: secondSectionContent.venue.width, textAlign: secondSectionContent.venue.textAlign, fontSize: secondSectionContent.venue.fontSize, color: secondSectionContent.venue.color, textShadow: firstSectionTextShadow }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", style: { color: secondSectionContent.venue.labelColor, textShadow: firstSectionTextShadow }, children: [
                  "Venue: ",
                  event.venue
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-snug", children: event.address })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[2%]", style: { marginTop: secondSectionContent.cards.marginTop }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: dateOpacity2, x: dateX2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, width: secondSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${secondSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: secondSectionContent.cardTitle.width, textAlign: secondSectionContent.cardTitle.textAlign, fontSize: secondSectionContent.cardTitle.fontSize, color: secondSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Date & Time" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: secondSectionContent.cardBody.fontClassName, style: { width: secondSectionContent.cardBody.width, textAlign: secondSectionContent.cardBody.textAlign, fontSize: secondSectionContent.cardBody.fontSize, color: secondSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.date }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: secondSectionContent.cardBody.fontClassName, style: { width: secondSectionContent.cardBody.width, textAlign: secondSectionContent.cardBody.textAlign, fontSize: secondSectionContent.cardBody.fontSize, color: secondSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.time }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: secondSectionContent.cardBody.fontClassName, style: { width: secondSectionContent.cardBody.width, textAlign: secondSectionContent.cardBody.textAlign, fontSize: "2.8cqw", color: secondSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: "(followed by Lunch)" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: dressOpacity2, y: dressY2, rotate: dressRotate2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, marginTop: secondSectionContent.cards.gap, width: secondSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${secondSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: secondSectionContent.cardTitle.width, textAlign: secondSectionContent.cardTitle.textAlign, fontSize: secondSectionContent.cardTitle.fontSize, color: secondSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Dress Code" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: secondSectionContent.cardBody.fontClassName, style: { width: secondSectionContent.cardBody.width, textAlign: secondSectionContent.cardBody.textAlign, fontSize: secondSectionContent.cardBody.fontSize, color: secondSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.dressCode })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: qrOpacity2, scale: qrScale2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, marginTop: secondSectionContent.cards.gap, width: secondSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${secondSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: secondSectionContent.cardTitle.width, textAlign: secondSectionContent.cardTitle.textAlign, fontSize: secondSectionContent.cardTitle.fontSize, color: secondSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Venue QR" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: mapLink, target: "_blank", rel: "noreferrer", className: "group flex flex-col items-center mx-auto", "aria-label": `Open maps for ${event.title}`, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", style: { maxWidth: secondSectionContent.qr.maxWidth }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: qrUrl, alt: `QR code for ${event.venue}`, className: "w-full bg-white p-[2%] shadow-md", loading: "lazy" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${secondSectionContent.qr.fontClassName} mt-[2%] rounded-xl px-[3%] py-[2%] font-semibold transition group-hover:bg-white/90 whitespace-nowrap w-max max-w-none`, style: { backgroundColor: secondSectionContent.qr.labelBg, textAlign: secondSectionContent.qr.textAlign, fontSize: secondSectionContent.qr.labelFontSize, lineHeight: 1.2, color: secondSectionContent.qr.labelColor, textShadow: firstSectionTextShadow }, children: "Tap/Scan QR to Open Venue Map" })
                  ] })
                ] }) })
              ] })
            ] }) }) })
          ] }) })
        ] }) : isFourthSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0 z-0 pointer-events-none",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[1] mx-auto flex w-full justify-center", style: { minHeight: "max-content" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: firstSectionOverlayWidth, aspectRatio: "852 / 1261" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none z-[5]", children: MARIGOLD_PILE.map((f2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.img,
              {
                src: f2.img,
                alt: "",
                ...
                style: { left: f2.left, top: "-6%", width: f2.size },
                animate: { y: [0, 1050], x: f2.sway, rotate: f2.spin, opacity: [0, 1, 1, 0] },
                transition: { duration: f2.duration, repeat: Infinity, delay: f2.delay, ease: "linear" }
              },
              i
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "h-full w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-30 px-[4%]", style: { top: fourthSectionContent.title.top, left: fourthSectionContent.title.left, width: fourthSectionContent.title.width, textAlign: fourthSectionContent.title.textAlign }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.h3,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: subtitleOpacity4, y: subtitleY4, filter: subtitleFilter4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fourthSectionContent.subtitle.fontClassName} font-bold`, style: { marginTop: fourthSectionContent.subtitle.marginTop, marginLeft: fourthSectionContent.subtitle.left, width: fourthSectionContent.subtitle.width, textAlign: fourthSectionContent.subtitle.textAlign, fontSize: fourthSectionContent.subtitle.fontSize, color: fourthSectionContent.subtitle.color, textShadow: firstSectionTextShadow }, children: event.subtitle }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: venueOpacity4, x: venueX4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: fourthSectionContent.venue.fontClassName, style: { marginTop: fourthSectionContent.venue.marginTop, marginLeft: fourthSectionContent.venue.left, width: fourthSectionContent.venue.width, textAlign: fourthSectionContent.venue.textAlign, fontSize: fourthSectionContent.venue.fontSize, color: fourthSectionContent.venue.color, textShadow: firstSectionTextShadow }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", style: { color: fourthSectionContent.venue.labelColor, textShadow: firstSectionTextShadow }, children: [
                      "Venue: ",
                      event.venue
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-snug", children: event.address })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[2%]", style: { marginTop: fourthSectionContent.cards.marginTop }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: dateOpacity4, x: dateX4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, width: fourthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fourthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: fourthSectionContent.cardTitle.width, textAlign: fourthSectionContent.cardTitle.textAlign, fontSize: fourthSectionContent.cardTitle.fontSize, color: fourthSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Date & Time" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fourthSectionContent.cardBody.fontClassName, style: { width: fourthSectionContent.cardBody.width, textAlign: fourthSectionContent.cardBody.textAlign, fontSize: fourthSectionContent.cardBody.fontSize, color: fourthSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.date }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fourthSectionContent.cardBody.fontClassName, style: { width: fourthSectionContent.cardBody.width, textAlign: fourthSectionContent.cardBody.textAlign, fontSize: fourthSectionContent.cardBody.fontSize, color: fourthSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.time }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fourthSectionContent.cardBody.fontClassName, style: { width: fourthSectionContent.cardBody.width, textAlign: fourthSectionContent.cardBody.textAlign, fontSize: "2.8cqw", color: fourthSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: "(followed by Dinner)" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: dressOpacity4, y: dressY4, rotate: dressRotate4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, marginTop: fourthSectionContent.cards.gap, width: fourthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fourthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: fourthSectionContent.cardTitle.width, textAlign: fourthSectionContent.cardTitle.textAlign, fontSize: fourthSectionContent.cardTitle.fontSize, color: fourthSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Dress Code" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fourthSectionContent.cardBody.fontClassName, style: { width: fourthSectionContent.cardBody.width, textAlign: fourthSectionContent.cardBody.textAlign, fontSize: fourthSectionContent.cardBody.fontSize, color: fourthSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.dressCode })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: qrOpacity4, scale: qrScale4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, marginTop: fourthSectionContent.cards.gap, width: fourthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fourthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: fourthSectionContent.cardTitle.width, textAlign: fourthSectionContent.cardTitle.textAlign, fontSize: fourthSectionContent.cardTitle.fontSize, color: fourthSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Venue QR" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: mapLink, target: "_blank", rel: "noreferrer", className: "group flex flex-col items-center mx-auto", "aria-label": `Open maps for ${event.title}`, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", style: { maxWidth: fourthSectionContent.qr.maxWidth }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: qrUrl, alt: `QR code for ${event.venue}`, className: "w-full bg-white p-[2%] shadow-md", loading: "lazy" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${fourthSectionContent.qr.fontClassName} mt-[2%] rounded-xl px-[3%] py-[2%] font-semibold transition group-hover:bg-white/90 whitespace-nowrap w-max max-w-none`, style: { backgroundColor: fourthSectionContent.qr.labelBg, textAlign: fourthSectionContent.qr.textAlign, fontSize: fourthSectionContent.qr.labelFontSize, lineHeight: 1.2, color: fourthSectionContent.qr.labelColor, textShadow: firstSectionTextShadow }, children: "Tap/Scan QR to Open Venue Map" })
                      ] })
                    ] }) })
                  ] })
                ] }) })
        ...
        ] }) : isFifthSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0 z-0 pointer-events-none",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none z-[55]", children: WEDDING_LANTERNS.map((l2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              className: "absolute",
              style: { left: l2.left, top: "108%", width: l2.size },
              animate: { y: [0, -2600], x: l2.driftX, rotate: l2.rot },
              transition: { duration: l2.duration, delay: l2.delay, repeat: Infinity, ease: "linear" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.img,
                {
                  src: LANTERN_SRCS[l2.src],
                  alt: "",
                  "aria-hidden": "true",
                  ...
                  transition: { duration: 2.2, repeat: Infinity, ease: "easeInOut", delay: l2.delay % 2.2 }
                }
              )
            },
            i
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[1] mx-auto flex w-full justify-center", style: { minHeight: "max-content" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: firstSectionOverlayWidth, aspectRatio: "852 / 1261" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: wedFl2, alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { right: fifthSectionDecorations.fl2.right, top: fifthSectionDecorations.fl2.top, width: fifthSectionDecorations.fl2.width } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: wedFl1, alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: fifthSectionDecorations.fl1.left, top: fifthSectionDecorations.fl1.top, width: fifthSectionDecorations.fl1.width } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: wedLt, alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: fifthSectionDecorations.lt.left, top: fifthSectionDecorations.lt.top, width: fifthSectionDecorations.lt.width } }),
            [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: BELL_SRCS[0], alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: "15%", top: "11%", width: "8%" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: BELL_SRCS[1], alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: "25%", top: "6.9%", width: "5%" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: BELL_SRCS[2], alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: "21.3%", top: "8%", width: "4%" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: BELL_SRCS[2], alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: "75%", top: "8%", width: "4%" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: BELL_SRCS[1], alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: "70%", top: "6.6%", width: "5%" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: BELL_SRCS[0], alt: "", "aria-hidden": "true", className: "pointer-events-none absolute object-contain", style: { left: "77%", top: "10.2%", width: "8%" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none z-[9]", children: WEDDING_SPARKLES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                className: "absolute select-none",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "h-full w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-30 px-[4%]", style: { top: fifthSectionContent.title.top, left: fifthSectionContent.title.left, width: fifthSectionContent.title.width, textAlign: fifthSectionContent.title.textAlign }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.h3, { className: `${fifthSectionContent.title.fontClassName} leading-[1.05]`, style: { fontSize: fifthSectionContent.title.fontSize, color: fifthSectionContent.title.color, textShadow: fifthSectionTextShadow, opacity: titleOpacity5, scale: titleScale5 }, children: event.title }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: subtitleOpacity5, y: subtitleY5, filter: subtitleFilter5 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fifthSectionContent.subtitle.fontClassName} font-bold`, style: { marginTop: fifthSectionContent.subtitle.marginTop, marginLeft: fifthSectionContent.subtitle.left, width: fifthSectionContent.subtitle.width, textAlign: fifthSectionContent.subtitle.textAlign, fontSize: fifthSectionContent.subtitle.fontSize, color: fifthSectionContent.subtitle.color, textShadow: fifthSectionTextShadow }, children: event.subtitle }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: venueOpacity5, x: venueX5 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: fifthSectionContent.venue.fontClassName, style: { marginTop: fifthSectionContent.venue.marginTop, marginLeft: fifthSectionContent.venue.left, width: fifthSectionContent.venue.width, textAlign: fifthSectionContent.venue.textAlign, fontSize: fifthSectionContent.venue.fontSize, color: fifthSectionContent.venue.color, textShadow: fifthSectionTextShadow }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", style: { color: fifthSectionContent.venue.labelColor, textShadow: fifthSectionTextShadow }, children: [
                      "Venue: ",
                      event.venue
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-snug", children: event.address })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[2%]", style: { marginTop: fifthSectionContent.cards.marginTop }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: dateOpacity5, x: dateX5 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, width: fifthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fifthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: fifthSectionContent.cardTitle.width, textAlign: fifthSectionContent.cardTitle.textAlign, fontSize: fifthSectionContent.cardTitle.fontSize, color: fifthSectionContent.cardTitle.color, textShadow: fifthSectionTextShadow }, children: "Reception" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fifthSectionContent.cardBody.fontClassName, style: { width: fifthSectionContent.cardBody.width, textAlign: fifthSectionContent.cardBody.textAlign, fontSize: fifthSectionContent.cardBody.fontSize, color: fifthSectionContent.cardBody.color, textShadow: fifthSectionTextShadow }, children: event.date }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fifthSectionContent.cardBody.fontClassName, style: { width: fifthSectionContent.cardBody.width, textAlign: fifthSectionContent.cardBody.textAlign, fontSize: fifthSectionContent.cardBody.fontSize, color: fifthSectionContent.cardBody.color, textShadow: fifthSectionTextShadow }, children: event.time }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fifthSectionContent.cardBody.fontClassName, style: { width: fifthSectionContent.cardBody.width, textAlign: fifthSectionContent.cardBody.textAlign, fontSize: "2.8cqw", color: fifthSectionContent.cardBody.color, textShadow: fifthSectionTextShadow }, children: "(followed by Dinner)" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: dressOpacity5, y: dressY5, rotate: dressRotate5 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, marginTop: fifthSectionContent.cards.gap, width: fifthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fifthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: fifthSectionContent.cardTitle.width, textAlign: fifthSectionContent.cardTitle.textAlign, fontSize: fifthSectionContent.cardTitle.fontSize, color: fifthSectionContent.cardTitle.color, textShadow: fifthSectionTextShadow }, children: "Muhurtham" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fifthSectionContent.cardBody.fontClassName, style: { width: fifthSectionContent.cardBody.width, textAlign: fifthSectionContent.cardBody.textAlign, fontSize: fifthSectionContent.cardBody.fontSize, color: fifthSectionContent.cardBody.color, textShadow: fifthSectionTextShadow }, children: event.dressCode }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: fifthSectionContent.cardBody.fontClassName, style: { width: fifthSectionContent.cardBody.width, textAlign: fifthSectionContent.cardBody.textAlign, fontSize: "2.8cqw", color: fifthSectionContent.cardBody.color, textShadow: fifthSectionTextShadow }, children: "Sravana Nakshatram Vrushabha Lagnam" })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: qrOpacity5, scale: qrScale5 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, marginTop: fifthSectionContent.cards.gap, width: fifthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${fifthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: fifthSectionContent.cardTitle.width, textAlign: fifthSectionContent.cardTitle.textAlign, fontSize: fifthSectionContent.cardTitle.fontSize, color: fifthSectionContent.cardTitle.color, textShadow: fifthSectionTextShadow }, children: "Venue QR" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: mapLink, target: "_blank", rel: "noreferrer", className: "group flex flex-col items-center mx-auto", "aria-label": `Open maps for ${event.title}`, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", style: { maxWidth: fifthSectionContent.qr.maxWidth }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: qrUrl, alt: `QR code for ${event.venue}`, className: "w-full bg-white p-[2%] shadow-md", loading: "lazy" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${fifthSectionContent.qr.fontClassName} mt-[2%] rounded-xl px-[3%] py-[2%] font-semibold transition group-hover:bg-white/90 whitespace-nowrap w-max max-w-none`, style: { backgroundColor: fifthSectionContent.qr.labelBg, textAlign: fifthSectionContent.qr.textAlign, fontSize: fifthSectionContent.qr.labelFontSize, lineHeight: 1.2, color: fifthSectionContent.qr.labelColor, textShadow: fifthSectionTextShadow }, children: "Tap/Scan QR to Open Venue Map" })
                      ] })
                    ] }) })
                  ] })
                ] }) })
        ...
        ] }) : isSixthSection ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0 z-0 pointer-events-none",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[1] mx-auto flex w-full justify-center", style: { minHeight: "max-content" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", style: { width: firstSectionOverlayWidth, aspectRatio: "852 / 1261" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none z-[2]", children: [
              { left: "8%", top: "12%", size: "4%", delay: 0, duration: 3.4 },
              ...
              { left: "14%", top: "40%", size: "3.4%", delay: 1.4, duration: 4 },
              { left: "22%", top: "56%", size: "3%", delay: 0.2, duration: 3.7 },
              { left: "34%", top: "44%", size: "3.2%", delay: 1, duration: 3.6 },
              ...
              { left: "70%", top: "84%", size: "3.4%", delay: 2, duration: 3.7 },
              { left: "82%", top: "74%", size: "3%", delay: 0.6, duration: 3.3 }
            ].map((sparkle, index22) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                className: "absolute rounded-full",
                style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "h-full w-full text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute z-30 px-[4%]", style: { top: sixthSectionContent.title.top, left: sixthSectionContent.title.left, width: sixthSectionContent.title.width, textAlign: sixthSectionContent.title.textAlign }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.h3,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: subtitleOpacity6, y: subtitleY6, filter: subtitleFilter6 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${sixthSectionContent.subtitle.fontClassName} font-bold`, style: { marginTop: sixthSectionContent.subtitle.marginTop, marginLeft: sixthSectionContent.subtitle.left, width: sixthSectionContent.subtitle.width, textAlign: sixthSectionContent.subtitle.textAlign, fontSize: sixthSectionContent.subtitle.fontSize, color: sixthSectionContent.subtitle.color, textShadow: firstSectionTextShadow }, children: event.subtitle }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: venueOpacity6, x: venueX6 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: sixthSectionContent.venue.fontClassName, style: { marginTop: sixthSectionContent.venue.marginTop, marginLeft: sixthSectionContent.venue.left, width: sixthSectionContent.venue.width, textAlign: sixthSectionContent.venue.textAlign, fontSize: sixthSectionContent.venue.fontSize, color: sixthSectionContent.venue.color, textShadow: firstSectionTextShadow }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", style: { color: sixthSectionContent.venue.labelColor, textShadow: firstSectionTextShadow }, children: [
                      "Venue: ",
                      event.venue
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-snug text-[2.7cqw]", children: event.address })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-[2%]", style: { marginTop: sixthSectionContent.cards.marginTop }, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: dateOpacity6, x: dateX6 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, width: sixthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${sixthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: sixthSectionContent.cardTitle.width, textAlign: sixthSectionContent.cardTitle.textAlign, fontSize: sixthSectionContent.cardTitle.fontSize, color: sixthSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Date & Time" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: sixthSectionContent.cardBody.fontClassName, style: { width: sixthSectionContent.cardBody.width, textAlign: sixthSectionContent.cardBody.textAlign, fontSize: sixthSectionContent.cardBody.fontSize, color: sixthSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.date }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: sixthSectionContent.cardBody.fontClassName, style: { width: sixthSectionContent.cardBody.width, textAlign: sixthSectionContent.cardBody.textAlign, fontSize: sixthSectionContent.cardBody.fontSize, color: sixthSectionContent.cardBody.color, textShadow: firstSectionTextShadow }, children: event.time })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { style: { opacity: qrOpacity6, scale: qrScale6 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: `${layout2.cardClass} px-[3.2%] py-[2.7%]`, style: { backgroundColor: layout2.cardBg, marginTop: sixthSectionContent.cards.gap, width: sixthSectionContent.cards.width, marginInline: "auto" }, whileHover: { scale: 1.01 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `${sixthSectionContent.cardTitle.fontClassName} font-semibold`, style: { width: sixthSectionContent.cardTitle.width, textAlign: sixthSectionContent.cardTitle.textAlign, fontSize: sixthSectionContent.cardTitle.fontSize, color: sixthSectionContent.cardTitle.color, textShadow: firstSectionTextShadow }, children: "Venue QR" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: mapLink, target: "_blank", rel: "noreferrer", className: "group flex flex-col items-center mx-auto", "aria-label": `Open maps for ${event.title}`, children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden", style: { maxWidth: sixthSectionContent.qr.maxWidth }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: qrUrl, alt: `QR code for ${event.venue}`, className: "w-full bg-white p-[2%] shadow-md", loading: "lazy" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${sixthSectionContent.qr.fontClassName} mt-[2%] rounded-xl px-[3%] py-[2%] font-semibold transition group-hover:bg-white/90 whitespace-nowrap w-max max-w-none`, style: { backgroundColor: sixthSectionContent.qr.labelBg, textAlign: sixthSectionContent.qr.textAlign, fontSize: sixthSectionContent.qr.labelFontSize, lineHeight: 1.2, color: sixthSectionContent.qr.labelColor, textShadow: firstSectionTextShadow }, children: "Tap/Scan QR to Open Venue Map" })
                      ] })
                    ] }) })
                  ] })
                ] }) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(layout2.Decor, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `max-w-xl mx-auto relative z-20 ${layout2.align}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 sm:p-8 relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "rotateIn", delay: 0.02, amount: 0.6, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                className: "absolute right-6 top-2",
                animate: { y: [0, -8, 0], rotate: [0, 7, 0] },
                transition: { duration: 2.9, repeat: Infinity },
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(MotifSticker, { motif: event.motif, accent: event.theme.accent })
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: layout2.titleAnim, delay: 0.06, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-3xl sm:text-4xl text-white mb-1", children: event.title }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "blurIn", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 font-semibold mb-5", children: event.subtitle }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "slideRight", delay: 0.12, amount: 0.5, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 text-sm text-white/75", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold text-white", children: [
                "Venue: ",
                event.venue
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: event.address })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "slideLeft", delay: 0.15, amount: 0.55, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  className: layout2.cardClass,
                  style: { backgroundColor: layout2.cardBg },
                  whileHover: { scale: 1.01 },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white mb-2", children: "Date & Time" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80", children: event.date }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80", children: event.time })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "slideRight", delay: 0.22, amount: 0.55, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  className: layout2.cardClass,
                  style: { backgroundColor: layout2.cardBg },
                  whileHover: { scale: 1.01 },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white mb-2", children: "Dress Code" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80", children: event.dressCode })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "zoomIn", delay: 0.28, amount: 0.55, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  className: layout2.cardClass,
                  style: { backgroundColor: layout2.cardBg },
                  whileHover: { scale: 1.01 },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-white mb-2", children: "Venue QR" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "a",
                      {
                        href: mapLink,
                        ...
                        "aria-label": `Open maps for ${event.title}`,
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-[220px] overflow-hidden rounded-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: qrUrl, alt: `QR code for ${event.venue}`, className: "w-full bg-white p-2 rounded-2xl shadow-md", loading: "lazy" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 px-3 py-2 bg-white/70 text-[#5f4a56] font-semibold text-center rounded-xl group-hover:bg-white/90 transition text-sm whitespace-nowrap w-max max-w-none", children: "Tap/Scan QR to Open Venue Map" })
                        ]
                      }
                    )
                  ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-white/60 font-semibold mb-3", children: "Animated Story Beats" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-2 mb-5", children: event.storyFrames.map((frame2, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "blurIn", delay: 0.33, amount: 0.55, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(PopArtImage, { accent: event.theme.accent, ink: event.theme.ink, label: "Poster Frame A", variant: 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(PopArtImage, { accent: event.theme.accent, ink: event.theme.ink, label: "Poster Frame B", variant: 2 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(PopArtImage, { accent: event.theme.accent, ink: event.theme.ink, label: "Poster Frame C", variant: 1 })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: "fadeUp", delay: 0.36, amount: 0.55, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                className: "mt-5 text-sm text-white/75 leading-relaxed",
                animate: { opacity: [0.95, 1, 0.95] },
                transition: { duration: 3, repeat: Infinity },
                children: event.designNote
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid grid-cols-1 sm:grid-cols-3 gap-2 text-sm", children: event.highlights.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { type: idx % 2 === 0 ? "slideLeft" : "slideRight", delay: 0.05 * idx, amount: 0.55, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen w-full bg-white overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AmbientToggle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "hero", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "events", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EventSchedule, {}) })
    ] })
  ] });
}
const index = "";
